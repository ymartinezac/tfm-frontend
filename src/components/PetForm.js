...
function PetForm({ toggleModal, petId, setPetId }) {
    ...
    React.useEffect(() => {
        ...
        if (!(petId === null)) {
            console.log(
                '🚀 ~ file: PetForm.js ~ line 33 ~ React.useEffect ~ petId',
                petId
            )
    ...
    const handleSubmit = () => {
        ...
        if (!petPhotoFile) {
            ...
            console.log(
                '🚀 ~ file: PetForm.js ~ line 55 ~ handleSubmit ~ petPhotoFile',
                petPhotoFile
            )
            if (petId === null) {
                ps.addPet(formData)
        ...
        >
            <form className="pet-form" encType="multipart/form-data">
                ...
                <FormGroup>
                    <p>Compatibility:</p>
                    <FormControlLabel
                        control={<Checkbox onChange={handleKidsCheckbox} />}
                        label="Kids"
                    />
                    <FormControlLabel
                        control={<Checkbox onChange={handlePetsCheckbox} />}
                        label="Other pets"
                    />
                </FormGroup>
                <div className="pet-form__input-group">
                    ...
                    >
                        ...
                        <Select
                            ...
                            size="small"
                        >
                            <MenuItem value={'cat'} size="small">
                                Cat
                            </MenuItem>
                            <MenuItem value={'dog'} size="small">
                                Dog
                            </MenuItem>
                            <MenuItem value={'other'} size="small">
                                Other
                            </MenuItem>
                        </Select>
                    </FormControl>
